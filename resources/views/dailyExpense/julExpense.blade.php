  ...
  <div class="w3-container">
    <div class="row">
      ...
      <div class="title"><h1>Daily Expense & Income</h1>
        <p>Record your daily expenses and incomes.</p> <h2>July</h2> </div>
  ...
  <div class="modal fade" id="moneyPlus-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ route('addjulIncomes') }}" method="post" enctype="multipart/form-data"> @csrf
        <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Date</label>
                  <input type="date" name="Indate" class="form-control" max="2022-07-31" min="2022-07-01" required/>
                </div>
              </div>
            </div>
  ...
  <div class="modal fade" id="moneyMinus-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ route('addjulExpenses') }}" method="post" enctype="multipart/form-data"> @csrf
        <div class="modal-body">
            <div class="form-group">
              <label>Name</label>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Date</label>
                  <input type="date" name="Exdate" class="form-control" max="2022-07-31" min="2022-07-01" required/>
                </div>
              </div>
            </div>
          ...
          <li class="historyLists" >
            <div class="row" >
              ...
              <div class="col-md-1 list-button">
                <a href="{{route('deletejulInc',['id'=>$income->id])}}" id="btn-delete" onClick="return confirm('Are you sure you want to delete this income?')"><i class="fa-solid fa-trash-can"></i></a> <br>
                <a href="{{route('editjulIncome',['id'=>$income->id])}}" id="btn-edit"><i class="fa-solid fa-pen-to-square"></i></a>
              </div>
            </div>
          </li>
        </ul>
      ...
      <div class="explist-group">
        ...
        <li class="historyLists">
            ...
            <div class="col-md-2 money-image">
              ...
              <div class="col-md-1 list-button">
                <a href="{{route('deletejulExp',['id'=>$expense->id])}}" id="btn-delete" onClick="return confirm('Are you sure you want to delete this expense?')"><i class="fa-solid fa-trash-can"></i></a> <br>
                <a href="{{route('editjulExpense',['id'=>$expense->id])}}" id="btn-edit"><i class="fa-solid fa-pen-to-square"></i></a>
              </div>
            </div>
          </li>
        </ul> 
