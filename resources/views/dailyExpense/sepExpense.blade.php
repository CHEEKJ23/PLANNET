  ...
  function w3_close() {
    document.getElementById("mySidebar").style.display = "none";
      ...
      <div class="w3-sidebar w3-bar-block w3-border-right" style="display:none" id="mySidebar">
        ...
        <a href="{{ route('dailyExpenses2') }}" class="w3-bar-item w3-button">February</a>
  ...
  <div class="w3-container">
    <div class="row">
      ...
      <div class="title"><h1>Daily Expense & Income</h1>
        <p>Record your daily expenses and incomes.</p> <h2>September</h2> </div>
        <img src="/images/moneyinout.png" width="300" height="300" style="position: absolute; top: 65px; right: 16px; font-size: 18px;" alt="todo">
        <img src="/images/savemoney.png" width="300" height="300" style="position: absolute; top: 205px; left: 16px; font-size: 18px;" alt="todo"></div>
    </div>
</div>
  ...
  <div class="modal fade" id="moneyPlus-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ route('addsepIncomes') }}" method="post" enctype="multipart/form-data"> @csrf
        <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Date</label>
                  <input type="date" name="Indate" class="form-control" max="2022-09-30" min="2022-09-01" required/>
                </div>
              </div>
            </div>
  ...
  <div class="modal fade" id="moneyMinus-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ route('addsepExpenses') }}" method="post" enctype="multipart/form-data"> @csrf
        <div class="modal-body">
            <div class="form-group">
              <label>Name</label>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Date</label>
                  <input type="date" name="Exdate" class="form-control" max="2022-09-30" min="2022-09-01" required/>
                </div>
              </div>
            </div>
          ...
          <li class="historyLists" >
            <div class="row" >
              ...
              <div class="col-md-1 list-button">
                <a href="{{route('deletesepInc',['id'=>$income->id])}}" id="btn-delete" onClick="return confirm('Are you sure you want to delete this income?')"><i class="fa-solid fa-trash-can"></i></a> <br>
                <a href="{{route('editsepIncome',['id'=>$income->id])}}" id="btn-edit"><i class="fa-solid fa-pen-to-square"></i></a>
              </div>
            </div>
          </li>
        </ul>
      ...
      <div class="explist-group">
        ...
        <li class="historyLists">
            ...
            <div class="col-md-2 money-image">
              ...
              <div class="col-md-1 list-button">
                <a href="{{route('deletesepExp',['id'=>$expense->id])}}" id="btn-delete" onClick="return confirm('Are you sure you want to delete this expense?')"><i class="fa-solid fa-trash-can"></i></a> <br>
                <a href="{{route('editsepExpense',['id'=>$expense->id])}}" id="btn-edit"><i class="fa-solid fa-pen-to-square"></i></a>
              </div>
            </div>
          </li>
        </ul> 
